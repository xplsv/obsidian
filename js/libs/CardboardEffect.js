...
THREE.CardboardEffect = function ( renderer ) {
	...
	this.clear = function () {
		...
		_renderTarget.scissor.set( 0, 0, _renderTarget.width, _renderTarget.height );
		_renderTarget.viewport.set( 0, 0, _renderTarget.width, _renderTarget.height );


		renderer.clearTarget( _renderTarget );
